...
{
    unsigned long newPtr = *index + delta;
    barrier();
...
// Implementing using interrupt handling
// Interrupt handler should be placed in the initialise function
// and cleared at the end of the release function
